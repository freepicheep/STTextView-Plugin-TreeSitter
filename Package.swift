...
let package = Package(
    ...
    targets: [
        .target(
            name: "STPluginTreeSitter",
            dependencies: [
                .target(name: "STPluginTreeSitterAppKit", condition: .when(platforms: [.macOS])),
                .target(name: "STPluginTreeSitterUIKit", condition: .when(platforms: [.iOS, .macCatalyst]))
            ]
        ),
        .target(
        ...
        .target(
            name: "STPluginTreeSitterAppKit",
            dependencies: [
                .product(name: "STTextView", package: "STTextView"),
                .target(name: "STPluginTreeSitterCore"),
                .target(name: "TreeSitterResource")
            ],
            resources: [.process("Themes.xcassets")]
        ),
        .target(
            name: "STPluginTreeSitterUIKit",
            dependencies: [
                .product(name: "STTextView", package: "STTextView"),
                .target(name: "STPluginTreeSitterCore"),
                .target(name: "TreeSitterResource")
        ...
        .target(
            ...
            dependencies: [
                ...
                .target(name: "TreeSitterAstro"),
                .target(name: "TreeSitterAstroQueries"),
                .target(name: "TreeSitterComment"),
                .target(name: "TreeSitterCommentQueries"),
                .target(name: "TreeSitterElixir"),
                .target(name: "TreeSitterElixirQueries"),
                .target(name: "TreeSitterElm"),
                .target(name: "TreeSitterElmQueries"),
                .target(name: "TreeSitterHaskell"),
                .target(name: "TreeSitterHaskellQueries"),
                .target(name: "TreeSitterJSDoc"),
                .target(name: "TreeSitterJSDocQueries"),
                .target(name: "TreeSitterJSON5"),
                .target(name: "TreeSitterJSON5Queries"),
                .target(name: "TreeSitterJulia"),
                .target(name: "TreeSitterJuliaQueries"),
                .target(name: "TreeSitterLaTeX"),
                .target(name: "TreeSitterLaTeXQueries"),
                ...
                .target(name: "TreeSitterOCamlQueries"),
                .target(name: "TreeSitterPerl"),
                .target(name: "TreeSitterPerlQueries"),
                .target(name: "TreeSitterR"),
                .target(name: "TreeSitterRQueries"),
                .target(name: "TreeSitterRegex"),
                .target(name: "TreeSitterRegexQueries"),
                .target(name: "TreeSitterSCSS"),
                .target(name: "TreeSitterSCSSQueries"),
                .target(name: "TreeSitterSvelte"),
                .target(name: "TreeSitterSvelteQueries"),
        ...
        .testTarget(
            name: "STPluginTreeSitterCoreTests",
            dependencies: [
                "STPluginTreeSitterCore",
                "TreeSitterResource"
            ]
        ),
    ]
